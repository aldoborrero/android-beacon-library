 ...
 * It needs only the current value to do this; the general formula is  n(t) = n(t-1) - c * (n(t-1)
 * -
 * n(t))
 * where c is a coefficient, that denotes the smoothness - the lower the value, the smoother the
 * average
...
public class ArmaRssiFilter implements RssiFilter {
  ...
  public void addMeasurement(Integer rssi) {
    ...
    armaMeasurement =
        Double.valueOf(armaMeasurement - armaSpeed * (armaMeasurement - rssi)).intValue();
  ...
  public static void setDefaultArmaSpeed(double armaSpeed) {
    DEFAULT_ARMA_SPEED = armaSpeed;
  }
}
