...
public class RunningAverageRssiFilter implements RssiFilter {
  ...
  @Override public void addMeasurement(Integer rssi) {
  ...
  @Override public boolean noMeasurementsAvailable() {
    return mMeasurements.size() == 0;
  }

  @Override public double calculateRssi() {
    refreshMeasurements();
  ...
  private class Measurement implements Comparable<Measurement> {
    ...
    @Override public int compareTo(Measurement arg0) {
