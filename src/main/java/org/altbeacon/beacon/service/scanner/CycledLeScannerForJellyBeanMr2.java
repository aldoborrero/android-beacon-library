...
public class CycledLeScannerForJellyBeanMr2 extends CycledLeScanner {
  ...
  @SuppressWarnings("deprecation") @Override protected void stopScan() {
    try {
  ...
  @Override protected boolean deferScanIfNeeded() {
  ...
  @SuppressWarnings("deprecation") @Override protected void startScan() {
    getBluetoothAdapter().startLeScan(getLeScanCallback());
  }

  @SuppressWarnings("deprecation") @Override protected void finishScan() {
  ...
  private BluetoothAdapter.LeScanCallback getLeScanCallback() {
    if (leScanCallback == null) {
      leScanCallback = new BluetoothAdapter.LeScanCallback() {
        ...
        @Override public void onLeScan(final BluetoothDevice device, final int rssi,
