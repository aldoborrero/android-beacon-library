...
public class BeaconIntentProcessor extends IntentService {
  ...
  @Override protected void onHandleIntent(Intent intent) {
    ...
    if (rangingData != null) {
      ...
      RangeNotifier dataNotifier =
          BeaconManager.getInstanceForApplication(this).getDataRequestNotifier();
    ...
    if (monitoringData != null) {
      ...
      MonitorNotifier notifier =
          BeaconManager.getInstanceForApplication(this).getMonitoringNotifier();
      if (notifier != null) {
        LogManager.d(TAG, "Calling monitoring notifier: %s", notifier);
        notifier.didDetermineStateForRegion(
            monitoringData.isInside() ? MonitorNotifier.INSIDE : MonitorNotifier.OUTSIDE,
