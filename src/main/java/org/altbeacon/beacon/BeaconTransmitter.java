 ...
 */
@TargetApi(Build.VERSION_CODES.LOLLIPOP) public class BeaconTransmitter {
  ...
  public void startAdvertising() {
    ...
    String byteString = "";
    for (byte advertisingByte : advertisingBytes) {
      byteString += String.format("%02X", advertisingByte);
      byteString += " ";
    }
    LogManager.d(TAG,
