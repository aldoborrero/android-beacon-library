...
/**
 * This class estimates the distance between the mobile device and a BLE beacon based on the
 * measured
...
public class CurveFittedDistanceCalculator implements DistanceCalculator {
   ...
   */
  public CurveFittedDistanceCalculator(double coefficient1, double coefficient2,
      double coefficient3) {
   ...
   */
  @Override public double calculateDistance(int txPower, double rssi) {
    if (rssi == 0) {
