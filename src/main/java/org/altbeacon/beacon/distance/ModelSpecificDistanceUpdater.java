...
public class ModelSpecificDistanceUpdater extends AsyncTask<Void, Void, Void> {
  ...
  @Override protected Void doInBackground(Void... params) {
    ...
    if (mCompletionHandler != null) {
      mCompletionHandler.onComplete(mDistanceConfigFetcher.getResponseString(),
          mDistanceConfigFetcher.getException(), mDistanceConfigFetcher.getResponseCode());
    }
    return null;
  }
  ...
  public ModelSpecificDistanceUpdater(Context context, String urlString,
